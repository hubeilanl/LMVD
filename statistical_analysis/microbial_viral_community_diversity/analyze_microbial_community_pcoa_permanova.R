...
distance_file <- "bray_curtis_dissimilarity_microbial_community.tsv"
metadata_file <- "metadata.txt"
coordinate_output_file <- "pcoa_coordinates_microbial_community.tsv"
permanova_output_file <- "permanova_microbial_community.tsv"
pcoa_figure_output_file <- "pcoa_microbial_community.pdf"
permutations <- 999
